        ...
        <div className="min-h-screen bg-[#F6F8FB] p-4 font-sans">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                <StatCard
                    ...
                    value="30,0000"
                    icon={<svg width="44" height="44" fill="none"><g><circle cx="22" cy="22" r="22" fill="#E4FDE3" /><path d="M30 30v-2a4 4 0 0 0-4-4H18a4 4 0 0 0-4 4v2" stroke="#23C16B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><circle cx="22" cy="18" r="4" stroke="#23C16B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></g></svg>}
                />
                <StatCard
                    title="Total Order"
                    value="3200"
                    icon={<svg width="44" height="44" fill="none"><g><circle cx="22" cy="22" r="22" fill="#FFEAE4" /><path d="M29 17V15a2 2 0 0 0-2-2h-6a2 2 0 0 0-2 2v2" stroke="#FF7A59" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><path d="M17 17h10v10a2 2 0 0 1-2 2H19a2 2 0 0 1-2-2V17z" stroke="#FF7A59" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></g></svg>}
                />
                <StatCard
                    title="Total Branch"
                    value="32450"
                    icon={<svg width="44" height="44" fill="none"><g><circle cx="22" cy="22" r="22" fill="#E6F2FF" /><path d="M22 28a6 6 0 1 0 0-12 6 6 0 0 0 0 12z" stroke="#2D9CDB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><path d="M22 16v-2m0 14v-2m-6-6H8m28 0h-8" stroke="#2D9CDB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></g></svg>}
                />
                <StatCard
                    title="Total Delivery Boy"
                    value="120"
                    icon={<svg width="44" height="44" fill="none"><g><circle cx="22" cy="22" r="22" fill="#FFF4E4" /><path d="M30 30v-2a4 4 0 0 0-4-4H18a4 4 0 0 0-4 4v2" stroke="#FF9800" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><circle cx="22" cy="18" r="4" stroke="#FF9800" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></g></svg>}
                />
            </div>
            {/* Main Content */}
