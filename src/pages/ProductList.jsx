...
const ProductList = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F6F8FB] p-4 pt-20 font-sans">
            ...
            <div className="overflow-x-auto rounded-xll shadow bg-white border">
                {loading ? (
                        ...
                        <table className="min-w-full text-sm text-gray-800">
                            <thead>
                                <tr className="bg-[#EB627D] text-white text-left">
                                    ...
                                    <th className="py-3 px-4">Available Product Quantity</th>
                            ...
                            <tbody>
                                {paginated.map((item, index) => (
                                    <tr key={item.id || index} className={index % 2 === 0 ? "bg-white" : "bg-pink-50"}>
                                        ...
                                        <td className="py-3 px-4">{item.brand?.brand_name || "--"}</td>
                                        <td className="py-3 px-4">{item.category?.category || "--"}</td>
                                        <td className="py-3 px-4">{item.subcategory?.name || "--"}</td>
                                        ...
                                        <td className="py-3 px-4">{item.basePrice || item.product_base_price || "--"}</td>
                                        <td className="py-3 px-4">{item.product_selling_price || "--"}</td>
            ...
            {modalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
                    <div className="bg-white p-6 rounded shadow-lg min-w-[300px]">
                        ...
                        <p className="mb-4">Update quantity for product: <strong>{filtered[selectedProductIndex]?.name}</strong></p>
